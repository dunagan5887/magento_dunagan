    ...
    extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected $_status_to_detail_label_mapping = array(
        Dunagan_ProcessQueue_Model_Task::STATUS_PENDING => 'In Progress',
        Dunagan_ProcessQueue_Model_Task::STATUS_PROCESSING => 'In Progress',
        Dunagan_ProcessQueue_Model_Task::STATUS_COMPLETE => 'Completed',
        Dunagan_ProcessQueue_Model_Task::STATUS_ERROR => 'Awaiting Retry',
        Dunagan_ProcessQueue_Model_Task::STATUS_ABORTED => 'Failed'
    );
    ...
    protected function _setHeaderText()
    {
        ...
        $header_text = Mage::helper('dunagan_process_queue')
    ...
    public function getTaskCountsByStatusDetailLabel()
    {
        ...
        foreach ($all_process_queue_tasks as $task)
        {
            ...
            $status_detail_label = isset($this->_status_to_detail_label_mapping[$status])
                ...
                : $this->_status_to_detail_label_mapping[Dunagan_ProcessQueue_Model_Task::STATUS_ABORTED];
